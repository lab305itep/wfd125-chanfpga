...
module wb_intercon
   (input         wb_clk_i,
    ...
    output [31:0] wb_err_array_adr_o,
    output [31:0] wb_err_array_dat_o,
    output  [3:0] wb_err_array_sel_o,
    output        wb_err_array_we_o,
    output        wb_err_array_cyc_o,
    output        wb_err_array_stb_o,
    output  [2:0] wb_err_array_cti_o,
    output  [1:0] wb_err_array_bte_o,
    input  [31:0] wb_err_array_dat_i,
    input         wb_err_array_ack_i,
    input         wb_err_array_err_i,
    input         wb_err_array_stall_i,
    input         wb_err_array_rty_i);

wb_mux
  #(.num_slaves (8),
    .MATCH_ADDR ({32'h00000000, 32'h00000008, 32'h00000010, 32'h00000020, 32'h00000080, 32'h000000c0, 32'h00000100, 32'h00000060}),
    .MATCH_MASK ({32'hfffffff8, 32'hfffffff8, 32'hfffffff8, 32'hffffffe0, 32'hffffffc0, 32'hffffffc0, 32'hffffffc0, 32'hffffffe0}))
 wb_mux_spi_master
   (.wb_clk_i    (wb_clk_i),
    .wb_rst_i    (wb_rst_i),
    ...
    .wbs_adr_o   ({wb_reg_csr_adr_o, wb_reg_ver_adr_o, wb_adc_spi_adr_o, wb_i2c_clk_adr_o, wb_reg_array_adr_o, wb_ped_array_adr_o, wb_err_array_adr_o, wb_bs_array_adr_o}),
    .wbs_dat_o   ({wb_reg_csr_dat_o, wb_reg_ver_dat_o, wb_adc_spi_dat_o, wb_i2c_clk_dat_o, wb_reg_array_dat_o, wb_ped_array_dat_o, wb_err_array_dat_o, wb_bs_array_dat_o}),
    .wbs_sel_o   ({wb_reg_csr_sel_o, wb_reg_ver_sel_o, wb_adc_spi_sel_o, wb_i2c_clk_sel_o, wb_reg_array_sel_o, wb_ped_array_sel_o, wb_err_array_sel_o, wb_bs_array_sel_o}),
    .wbs_we_o    ({wb_reg_csr_we_o, wb_reg_ver_we_o, wb_adc_spi_we_o, wb_i2c_clk_we_o, wb_reg_array_we_o, wb_ped_array_we_o, wb_err_array_we_o, wb_bs_array_we_o}),
    .wbs_cyc_o   ({wb_reg_csr_cyc_o, wb_reg_ver_cyc_o, wb_adc_spi_cyc_o, wb_i2c_clk_cyc_o, wb_reg_array_cyc_o, wb_ped_array_cyc_o, wb_err_array_cyc_o, wb_bs_array_cyc_o}),
    .wbs_stb_o   ({wb_reg_csr_stb_o, wb_reg_ver_stb_o, wb_adc_spi_stb_o, wb_i2c_clk_stb_o, wb_reg_array_stb_o, wb_ped_array_stb_o, wb_err_array_stb_o, wb_bs_array_stb_o}),
    .wbs_cti_o   ({wb_reg_csr_cti_o, wb_reg_ver_cti_o, wb_adc_spi_cti_o, wb_i2c_clk_cti_o, wb_reg_array_cti_o, wb_ped_array_cti_o, wb_err_array_cti_o, wb_bs_array_cti_o}),
    .wbs_bte_o   ({wb_reg_csr_bte_o, wb_reg_ver_bte_o, wb_adc_spi_bte_o, wb_i2c_clk_bte_o, wb_reg_array_bte_o, wb_ped_array_bte_o, wb_err_array_bte_o, wb_bs_array_bte_o}),
    .wbs_dat_i   ({wb_reg_csr_dat_i, wb_reg_ver_dat_i, wb_adc_spi_dat_i, wb_i2c_clk_dat_i, wb_reg_array_dat_i, wb_ped_array_dat_i, wb_err_array_dat_i, wb_bs_array_dat_i}),
    .wbs_ack_i   ({wb_reg_csr_ack_i, wb_reg_ver_ack_i, wb_adc_spi_ack_i, wb_i2c_clk_ack_i, wb_reg_array_ack_i, wb_ped_array_ack_i, wb_err_array_ack_i, wb_bs_array_ack_i}),
    .wbs_err_i   ({wb_reg_csr_err_i, wb_reg_ver_err_i, wb_adc_spi_err_i, wb_i2c_clk_err_i, wb_reg_array_err_i, wb_ped_array_err_i, wb_err_array_err_i, wb_bs_array_err_i}),
    .wbs_stall_i ({wb_reg_csr_stall_i, wb_reg_ver_stall_i, wb_adc_spi_stall_i, wb_i2c_clk_stall_i, wb_reg_array_stall_i, wb_ped_array_stall_i, wb_err_array_stall_i, wb_bs_array_stall_i}),
    .wbs_rty_i   ({wb_reg_csr_rty_i, wb_reg_ver_rty_i, wb_adc_spi_rty_i, wb_i2c_clk_rty_i, wb_reg_array_rty_i, wb_ped_array_rty_i, wb_err_array_rty_i, wb_bs_array_rty_i}));
